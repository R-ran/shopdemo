...
function sortProducts(products: ReturnType<typeof getBestsellerProducts>, sortBy?: string) {
...
function filterProducts(
  products: ReturnType<typeof getBestsellerProducts>,
  minPrice?: string,
  maxPrice?: string,
  inStock?: string,
  outOfStock?: string
...
export default function BestSellingPage({ searchParams }: BestSellingPageProps) {
  let products = getBestsellerProducts();
