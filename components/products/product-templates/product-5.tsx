...
export function Product5Template({ product }: ProductTemplateProps) {
  const [quantity, setQuantity] = useState(1);
  const [selectedSize, setSelectedSize] = useState('large');
  const [selectedColor, setSelectedColor] = useState('ivory-taupe');
  ...
  const colorOptions = [
    { value: 'ivory-taupe', label: 'IVORY/TAUPE' },
  ];
